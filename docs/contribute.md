...
When submitting a list PROPOSAL, please include:
...
If you can provide additional information, or want to suggest an update to a list, [open an issue](http://github.com/org-id/register/issues/new?title=UPDATE) or pull-request with your suggested changes.

Include details of the list you are proposing an update for, and links to any sources from your research.
